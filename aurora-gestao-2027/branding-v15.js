(()=>{
if(window.__auroraBrandingV19)return;window.__auroraBrandingV19=true;
const LOGO='/aurora-logo.png?v=19';
const LOGO_FALLBACK='https://raw.githubusercontent.com/diegofreitas09/pdf-link-nfc/main/aurora-gestao-2027/aurora-logo.png';
const WA='https://wa.me/5585984161882';
const style=document.createElement('style');style.textContent=`
.aurora19-logo{display:block;object-fit:contain}.mark{width:150px!important;height:105px!important;border-radius:18px!important;background:#fff!important;padding:6px!important}.mark .aurora19-logo{width:100%;height:100%}.brand{padding-top:2px!important}.brand .aurora19-logo{width:145px;height:82px;margin:0 0 8px 0;filter:drop-shadow(0 5px 14px #0003)}.aurora19-top{width:145px;height:80px;object-fit:contain;margin:0 0 10px 0;display:block}.dev-credit{margin-top:24px;padding:13px 12px;border-top:1px solid #ffffff22;color:#9eb2c5;font-size:10px;line-height:1.45}.dev-credit span{display:block;color:#7890a6;font-size:9px;text-transform:uppercase;letter-spacing:.08em;margin-bottom:3px}.dev-credit a{color:#fff;text-decoration:none;font-weight:800}.main-dev-credit{margin:30px 0 4px;padding:15px 0 2px;border-top:1px solid var(--l);font-size:10px;color:var(--m);text-align:center}.main-dev-credit a{color:var(--t);font-weight:800;text-decoration:none}@media(max-width:900px){.brand .aurora19-logo{width:110px;height:62px}.dev-credit{display:none}.aurora19-top{width:115px;height:64px}}@media print{.main-dev-credit{display:block!important;border-top:1px solid #bbb!important;color:#555!important}.main-dev-credit a{color:#111!important}}`;
document.head.appendChild(style);
function safeLogo(img){if(!img)return;img.classList.add('aurora19-logo');img.src=LOGO;img.onerror=()=>{img.onerror=null;img.src=LOGO_FALLBACK}}
function applyBrand(){
 ...
 const top=document.querySelector('.top>div:first-child');if(top){let img=top.querySelector('img[alt="Aurora"]');if(!img){img=document.createElement('img');img.alt='Aurora';top.insertAdjacentElement('afterbegin',img)}img.classList.add('aurora19-top');safeLogo(img)}
